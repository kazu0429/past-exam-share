    ...
    return(
        <>
            <div className={`${open ? "w-48" : "w-20"} h-screen p-5 pt-8 relative duration-300`}>
                ...
                <div className="">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="2 0 24 24" strokeWidth={1.5} stroke="currentColor" className="absolute cursor-pointer w-7 duration-500" onClick={() => router.push("/")}>
