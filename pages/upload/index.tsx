    ...
    return(
        ...
        <main className="h-screen flex-1 bg-indigo-50">
            ...
            <form className="w-full">
                <input placeholder="記事タイトル" className="m-5 text-xl  p-2 w-5/6  rounded-xl border border-gray-300" required onChange={(e) => setTitle(e.target.value)}/>
                <div className="flex">
                ...
                <div className="flex ml-5">
                    ...
                    { fielType &&  <label>選択<input type="file" className="hidden" accept={fielType}/></label>}
                </div>
            </form>
        </main>
        </>
